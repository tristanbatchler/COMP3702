...
![1566028405238](https://raw.githubusercontent.com/tristanbatchler/COMP3702/master/Images/Lecture%203/visibility-graph.png)

* Given initial (![I](https://latex.codecogs.com/gif.latex?I)) & goal (![G](https://latex.codecogs.com/gif.latex?G)) states:
  * Find the vertex ![q_i](https://latex.codecogs.com/gif.latex?q_i) nearest to ![I](https://latex.codecogs.com/gif.latex?I), where the straight line segment between ![I](https://latex.codecogs.com/gif.latex?I) and ![q_i](https://latex.codecogs.com/gif.latex?q_i) is collision-free
  * Similarly for ![G](https://latex.codecogs.com/gif.latex?G)
...
* Complexity (![n](https://latex.codecogs.com/gif.latex?n): total # of vertices of the obstaces)
  * Construction time (naive): ![O%28n%5E3%29](https://latex.codecogs.com/gif.latex?O%28n%5E3%29)
  * Space ![O%28n%5E2%29](https://latex.codecogs.com/gif.latex?O%28n%5E2%29)
...
![1566028802542](https://raw.githubusercontent.com/tristanbatchler/COMP3702/master/Images/Lecture%203/uniform-grid.png)

* Obstacles do not have to be represented as polygons
* Each grid cell that does not intersect with an obstacle becomes a vertex in the state graph. Edges between vertex ![v](https://latex.codecogs.com/gif.latex?v) and ![v%27](https://latex.codecogs.com/gif.latex?v%27) means ![v](https://latex.codecogs.com/gif.latex?v) and ![v%27](https://latex.codecogs.com/gif.latex?v%27) correspond to neighbouring grid cells
...
* **Configuration space / C-Space:** the set of all possible robot configurations
  ...
  * ![1566029151166](https://raw.githubusercontent.com/tristanbatchler/COMP3702/master/Images/Lecture%203/robot-arm-state-space.png)
  * A **configuration** is the parameters that uniquely defines the position of every point on the robot: ![q%20%3D%20%28q_1%2C%20q_2%2C%20...%2C%20q_n%29](https://latex.codecogs.com/gif.latex?q%20%3D%20%28q_1%2C%20q_2%2C%20...%2C%20q_n%29)
  ...
  * A configuration ![q](https://latex.codecogs.com/gif.latex?q) is **collision-free** is the robot placed at ![q](https://latex.codecogs.com/gif.latex?q) does not intersect any obstacles in the workspace
  ...
  * **Free Space**
    ...
    * ![CSpace%20%5Csetminus%20ForbiddenRegion](https://latex.codecogs.com/gif.latex?CSpace%20%5Csetminus%20ForbiddenRegion)
  ...
  **Action space & transition function for the robot**
    ...
    * Transition: ![q%27%20%3D%20q%20%2B%20a](https://latex.codecogs.com/gif.latex?q%27%20%3D%20q%20%2B%20a)
    
    * Where ![q](https://latex.codecogs.com/gif.latex?q) and ![q%27](https://latex.codecogs.com/gif.latex?q%27) are configuratons and ![a](https://latex.codecogs.com/gif.latex?a) is an action
...
* Visibility graph: polygon?
  ...
  * No way, way to frikken complicated :angry:
    ...
    ![1566029886325](https://raw.githubusercontent.com/tristanbatchler/COMP3702/master/Images/Lecture%203/c-space.png)

* Unifrom grid discretisation:

  * Each grid cell that does not intersect with an obstacle become sa vertex in the state graph
  * Edges between vertex ![v](https://latex.codecogs.com/gif.latex?v) and ![v%27](https://latex.codecogs.com/gif.latex?v%27) means ![v](https://latex.codecogs.com/gif.latex?v) and ![v%27](https://latex.codecogs.com/gif.latex?v%27) correspond to neighbouring grid cells
...
![1566030122482](https://raw.githubusercontent.com/tristanbatchler/COMP3702/master/Images/Lecture%203/alternative.png)
